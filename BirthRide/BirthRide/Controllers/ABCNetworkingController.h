 ...
 */
- (void)fetchRideWithToken:(NSString *)token withCompletion:(Ride *(^)(NSError *error))completionHandler;
...
/**
 ...
 @param token The authentication token associated with the user. This parameter is used to find the existing user associated with it or to create in the database a new user associated with it.
 @param completionHandler A completion handler to handle anything that needs to be done after the network request has finished.
 */
